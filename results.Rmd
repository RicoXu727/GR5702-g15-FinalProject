...
plot_ly(Sorted_data, x = ~total_amount, y = ~CatName,
                      ...
                      marker = list(opacity = 0.7,sizemode = "diameter")) %>% add_markers()%>%layout(title = 'Top 20 Wine Sale in Iowa', xaxis = list(title = 'Total_sales'), yaxis = list(title = 'Category Name'))
```
